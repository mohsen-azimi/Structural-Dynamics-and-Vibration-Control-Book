...
subplot(3,1,2)
    ...
    set(gca, 'LineWidth',1, 'FontWeight','normal', 'FontName','Times New Roman', 'FontSize',10)               
    ylabel('Velocity (m/s)', 'fontsize',12, 'fontname','Times New Roman','FontWeight','Bold')
...
subplot(3,1,3)
    ...
    ylabel('Acceleration (m/s^{2})', 'fontsize',12, 'fontname','Times New Roman','FontWeight','Bold')
