...
figure(1);  set(figure(1), 'Position', [200   100   883   300])
            ...
            ylabel(yLabels{yAxis}, 'fontsize',16, 'fontname','Times New Roman','FontWeight','Bold')
            legend('show')


........................................................
figure(1);  subplot(1,2,2); grid on; box on;

            mesh(z,x,y,'edgecolor','k'); zlim([0 2.8])
          
            set(gca, 'LineWidth',1, 'FontWeight','normal', 'FontName','Times New Roman', 'FontSize',14)               
            xlabel('\zeta', 'fontsize',16, 'fontname','Times New Roman','FontWeight','Bold')
            ylabel('\beta', 'fontsize',16, 'fontname','Times New Roman','FontWeight','Bold')
            zlabel(yLabels{yAxis}, 'fontsize',16, 'fontname','Times New Roman','FontWeight','Bold')
